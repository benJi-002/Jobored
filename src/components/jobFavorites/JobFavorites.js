...
const JobFavorites = (props) => {
    ...
    const [favEnded, setFavEnded] = useState(false);
        ...
        const items = arr.map((item, i) => {
            ...
            return (
                ...
                >
                    ...
                    <div 
                        className="job__item-star active"
                        tabIndex={0}
    ...
    const items = renderItems(favList);
